...
class SerieType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ...
            ->add('episodios', IntegerType::class, ['label' => 'Cantidad de episodios', 'constraints' => [new Positive()]])
            ->add('duracion', IntegerType::class, ['label' => 'Duración de episodios por minutos', 'constraints' => [new Positive()]])
            ->add('anio', IntegerType::class, ['label' => 'Año de estreno'])
